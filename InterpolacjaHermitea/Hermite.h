...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Stopieñ wielomianu";
			...
			this->label2->Text = L"Liczba wêz³ów";
			// 
			// label3
			// 
			...
			this->label4->Text = L"Krotnoœci kolejnych wêz³ów";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Wartoœci funkcji i pochodnych w wêz³ach";
			// 
			// label6
			// 
...
private: System::Void Hermite_Load(System::Object^  sender, System::EventArgs^  e) {
	this->textBox7->Text = "Witam! Proszê wprowadziæ wymagane dane, a nastêpnie klikn¹æ przycisk \"Licz!\"";
}
};
}
